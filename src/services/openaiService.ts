...
export class OpenAIService {
  static async gradeQuestion(question: QuestionToGrade, language: string): Promise<any> {
  ...
  static async generateFeedback(studentData: StudentData, language: string): Promise<string> {
    const controller = new AbortController();
    setActiveRequest(controller);
